...
class Watcher(object):
    ...
    @util.debuglog
    def manage_processes(self, force_respawn=False):
        """ manage processes.
        ...
        if (self.respawn or force_respawn
            and len(self.processes) < self.numprocesses):
    ...
    @util.debuglog
    def reap_and_manage_processes(self, force_respawn=False):
        ...
        if self.stopped:
            return
        self.reap_processes()
        self.manage_processes(force_respawn=force_respawn)
    ...
    def start(self):
        ...
        self.reap_processes()
        self.manage_processes(force_respawn=True)
